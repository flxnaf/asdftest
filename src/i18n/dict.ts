...
process: {
  ...
  cases: {
    ...
    items: [
      { id: "AL-204711", diagnosis: "Anterior crowding · Class I", complexity: "Moderate", stages: 32, months: 9.5, ipr: "3.4 mm", attachments: 6, tagKey: "Crowding" },
      { id: "AL-198320", diagnosis: "Spacing · midline diastema", complexity: "Mild", stages: 18, months: 5.0, ipr: "0 mm", attachments: 2, tagKey: "Spacing" },
      { id: "AL-211056", diagnosis: "Deep bite · 5 mm overbite", complexity: "Complex", stages: 44, months: 13.0, ipr: "2.1 mm", attachments: 10, tagKey: "Deep bite" },
      { id: "AL-220914", diagnosis: "Anterior crossbite · UR1", complexity: "Moderate", stages: 26, months: 7.5, ipr: "1.2 mm", attachments: 5, tagKey: "Crossbite" },
      { id: "AL-225608", diagnosis: "Class II div 1 · mild", complexity: "Moderate", stages: 38, months: 11.0, ipr: "2.8 mm", attachments: 8, tagKey: "Class II" },
      { id: "AL-231209", diagnosis: "Open bite · anterior", complexity: "Complex", stages: 42, months: 12.5, ipr: "1.6 mm", attachments: 9, tagKey: "Open bite" },
      { id: "AL-237015", diagnosis: "Relapse re-treatment", complexity: "Mild", stages: 14, months: 4.0, ipr: "0.8 mm", attachments: 3, tagKey: "Refinement" },
      { id: "AL-240388", diagnosis: "Crowding + rotation cluster", complexity: "Complex", stages: 36, months: 10.5, ipr: "4.0 mm", attachments: 8, tagKey: "Crowding" },
    ],
    filters: ["All", "Crowding", "Spacing", "Deep bite", "Class II", "Open bite", "Crossbite", "Refinement"],
  },
  team: {
...
process: {
  ...
  cases: {
    ...
    items: [
      { id: "AL-204711", diagnosis: "前牙擠迫 · Class I", complexity: "Moderate", stages: 32, months: 9.5, ipr: "3.4 mm", attachments: 6, tagKey: "Crowding" },
      { id: "AL-198320", diagnosis: "牙縫 · 正中縫", complexity: "Mild", stages: 18, months: 5.0, ipr: "0 mm", attachments: 2, tagKey: "Spacing" },
      { id: "AL-211056", diagnosis: "深咬 · 覆咬 5 mm", complexity: "Complex", stages: 44, months: 13.0, ipr: "2.1 mm", attachments: 10, tagKey: "Deep bite" },
      { id: "AL-220914", diagnosis: "前牙反咬 · UR1", complexity: "Moderate", stages: 26, months: 7.5, ipr: "1.2 mm", attachments: 5, tagKey: "Crossbite" },
      { id: "AL-225608", diagnosis: "Class II div 1 · 輕度", complexity: "Moderate", stages: 38, months: 11.0, ipr: "2.8 mm", attachments: 8, tagKey: "Class II" },
      { id: "AL-231209", diagnosis: "前牙開咬", complexity: "Complex", stages: 42, months: 12.5, ipr: "1.6 mm", attachments: 9, tagKey: "Open bite" },
      { id: "AL-237015", diagnosis: "復發再治療", complexity: "Mild", stages: 14, months: 4.0, ipr: "0.8 mm", attachments: 3, tagKey: "Refinement" },
      { id: "AL-240388", diagnosis: "擠迫加旋轉群組", complexity: "Complex", stages: 36, months: 10.5, ipr: "4.0 mm", attachments: 8, tagKey: "Crowding" },
    ],
    filters: ["全部", "擠迫", "牙縫", "深咬", "Class II", "開咬", "反咬", "中期調整"],
  },
  team: {
    eyebrow: "臨床領導",
